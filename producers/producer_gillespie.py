...
#####################################
# Message Generator - where I made changes.
#####################################
...
def generate_messages():
    ...
    while True:
        ...
        heart_rate = random.randint(55, 155)
        steps = random.randint(0, 60)
        activity = random.choice(["walking", "running", "resting", "cycling"])
        yield {
            "timestamp": timestamp,
